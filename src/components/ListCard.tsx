...
export default function ListCard({ filtered, allExpenses, onRowClick }: ListCardProps) {
  ...
  return (
    <div className="bg-bg-surface border border-bg-border rounded-xl p-6 flex flex-col min-h-[300px]">
